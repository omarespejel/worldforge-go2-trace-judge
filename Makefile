...
.PHONY: check replay report review dataset audit ranker real-photo-edit hf-dataset micro-world-scorer micro-world-demo micro-jepa-scorer micro-jepa-demo jepa-stretch model-honesty-audit dinov2-scorer dimos-replay-dataset dimos-replay-latent-dynamics replay-mpc-demo dimos-replay-stretch dimos-sim-probe dimos-cli-smoke dimos-macos-host-prep dimos-replay-smoke dimos-replay-smoke-bypass dimos-sim-smoke ml-stretch final-video bundle package all hackathon-final clean-generated photo-smoke
...
dimos-cli-smoke:
	$(PYTHON) scripts/dimos_smoke.py

dimos-macos-host-prep:
	scripts/dimos_macos_host_prep.sh
