...
Frame: `/Users/espejelomar/StarkNet/zk-ai/hackathons/worldforge-go2-trace-judge/artifacts/real_photo_edit_examples/example_01_red_left/camera_frame.jpg`
Target found: `True` confidence `0.0218`
Unsafe color risk: `0.0`

## Candidates
- `turn_left` score `0.8871`: turns target toward image center
- `turn_right` score `0.6791`: target is not right enough
