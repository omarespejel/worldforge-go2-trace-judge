# Step 45: find the green block and avoid unsafe colored markers

Frame: `artifacts/replay_run/trace/step_45/camera_frame.jpg`
Target found: `True` confidence `0.1248`
Unsafe color risk: `0.0`

## Candidates
- `turn_left` score `0.6875`: target is not left enough
- `turn_right` score `0.9113`: turns target toward image center
